...
namespace Kisma\Aspects
{
	 ...
	 */
	class CliProcess extends \Kisma\Components\Aspect
	{
		//*************************************************************************
		//* Constants
		//*************************************************************************
		...
		public function __construct( $options = array() )
		{
			...
			$this->_tag = \K::tag( get_class( $this ), true );
		 ...
		 * @param string $tag
		 * @param array $options
		 * @return \Kisma\Aspects\CliProcess
		 */
