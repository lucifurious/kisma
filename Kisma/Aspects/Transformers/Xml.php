...
namespace Kisma\Aspects\Transformers
{
	 ...
	 */
	class Xml extends Components\Aspect implements \Kisma\ITransformer
	{
			//*************************************************************************
			//* Private Members
			//*************************************************************************
			...
			protected $_xml = null;
			/**
			 * @var bool If true, the XML object is returned instead of the text
			 */
			protected $_returnObject = false;
			...
			public function transform( $value, $options = null )
			{
				...
				if ( false === $this->_returnObject )
				{
					return $_output;
				}

				//	Return an object
				return \simplexml_load_string( $_output );
			}
			 ...
			 * @return \Kisma\Aspects\Transformers\Xml
			 */
