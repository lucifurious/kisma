...
class Comment extends BaseModel
{
	...
	*/
	 ...
	 */
	public function getStatusText() { return YiiXL::o( $this->m_arStatusOptions, $this->status_nbr, 'Unknown (' . $this->status_nbr . ')' ); }
	...
	*/
	...
	{
		if ( ! empty( $this->url_text ) ) return YiiXL::link( YiiXL::encode( $this->author_name_text ), $this->url_text );
		return YiiXL::encode( $this->author_name_text );
	}
	...
	*/
	...
	{
		$this->content_display_text = YiiXL::markdownTransform( $this->content_text );
