 ...
 */
 	...
 	YiiXL::_rcf( $this->getAppBaseUrl() . '/css/form.css' );

	if ( Yii::app()->user->hasFlash( 'commentSubmitted' ) )
	{
		echo YiiXL::tag( 'h3', array(), 'Thanks!' );
	...
	$_arFormOpts = array( 
		...
		//	Our form fields...
		'fields' => array(
			array( YiiXL::TEXT, 'author_name_text', array( 'size' => 60, 'maxlength' => 255 ) ),
			array( YiiXL::TEXT, 'email_addr_text', array( 'class' => 'email', 'size' => 60, 'maxlength' => 255, 'hint' => 'Your email address will not be published.' ) ),
			array( YiiXL::TEXT, 'url_text', array( 'class' => 'url', 'size' => 60, 'maxlength' => 255 ) ),
			array( YiiXL::CKEDITOR, 'content_text' ),
			array( YiiXL::CAPTCHA, 'verifyCode', array( 'condition' => '( Yii::app()->user->isGuest && extension_loaded( \'gd\' ) )' ) ),
