...
class Markup
{
	...
	protected static function _tagPattern( $open = true, $selfClose = false )
	{
		if ( true === $open )
		{
			return static::_openStartDelimiter( $selfClose ) . static::ValuePlaceholder . static::_openEndDelimiter( $selfClose );
		}

		return static::_closeStartDelimiter() . static::ValuePlaceholder . static::_closeEndDelimiter();
	}
