...
class Render
{
	...
	{
		static::$_viewPaths = array_merge(
			Option::clean( static::$_viewPaths ),
			array( $path )
		);

		static::$_twigLoader = new \Twig_Loader_Filesystem( static::$_viewPaths );
		static::$_twigEnvironment = new \Twig_Environment( static::$_twigLoader );
	}
	...
	{
		if ( null !== static::$_twigEnvironment )
		{
			$_output = static::$_twigEnvironment->render(
				$viewFile,
				static::_getBaseRenderPayload( $viewFile, $payload )
			);
	...
	{
		static::$_twigEnvironment = $twigEnvironment;
	}
	...
	{
		return static::$_twigEnvironment;
	}
