...
class Session extends SeedBag
{
	...
	{
		\ini_set( 'session.gc_maxlifetime', static::SessionCookieGcTimeout + static::SessionCookieLifetime );
		\session_set_cookie_params( static::SessionCookieLifetime, static::SessionCookiePath );
		\session_start();
	...
	{
		static::$_sessionName = trim( strtolower( $sessionName ) );
	}
	...
	{
		static::$_sessionName = $sessionName;
	}
	...
	{
		return FilterInput::cookie( static::CookiePrefix . 'session_id', false );
	}
}
