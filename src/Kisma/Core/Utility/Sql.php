...
class Sql extends SeedUtility
{
    ...
    protected static function _checkConnection( &$parameters = array(), &$connection = null )
    {
        ...
        {
            throw new \Kisma\Core\Exceptions\StorageException(
                'Cannot proceed until a database connection has been established. Try setting the "connection" property.'
            );
        }
    ...
    public static function setConnectionString( $connectionString, $userName = null, $password = null, $pdoOptions = array() )
    {
        ...
        if ( !empty( $connectionString ) )
        {
            ...
            self::$_connection = new \PDO(
                self::$_connectionString, $userName, $password, array_merge(
                    array(
