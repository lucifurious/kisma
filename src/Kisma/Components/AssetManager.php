 ...
 * AssetManager
 */
class AssetManager extends SilexServiceProvider
{
	/**
	...
	public function register( Application $app )
	{
		...
		$app['assetic.factory'] = $app->share( function() use ( $app )
		{
			...
			$_factory = new AssetFactory( $app['assetic.path_to_web'], $_options['debug'] );
		...
		$app['assetic.asset_manager'] = $app->share( function () use ( $app )
		{
			...
			$_manager = new Assetic\AssetManager();
		...
		$app['assetic.lazy_asset_manager'] = $app->share( function () use ( $app )
		{
			...
			$_options = $app['assetic.options'];
			$_assMan = new LazyAssetmanager( $app['assetic.factory'] );
