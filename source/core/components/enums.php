...
interface IComponent extends IOptions
{
	//*************************************************************************
	//* Constants 
	//*************************************************************************
 ...
 */
interface IObservable extends IComponent
{
	//*************************************************************************
	//* Constants
	//*************************************************************************
	 ...
	 * @return integer
	 */
	public function getLoggingFlags();

	/**
	 * Sets the debug level
	 * @param #P#C\kisma\interfaces\IObservable.DEVELOPMENT|int|? $value
	 * @return integer The previous value
	 */
	public function setLoggingFlags( $value = self::DEVELOPMENT );
}
 ...
 */
interface IBehavior extends IBehavior
{
	/**
	 * Bind a callback to an event
	 * @abstract
	 * @param IEvent|IComponent $caller
 ...
 * This interface defines constants for, and identifies an object as, a YiiXL component
 */
interface IApplicationComponent extends IConfigurable
{
}
 ...
 * YiiXL system.
 */
interface IHelper extends IConfigurable
{
	/**
 ...
 * @see YiiXL
 */
interface IShifter extends IHelper
{
}
 ...
 */
interface IUIHelper extends IHelper, IForm
{
}
 ...
 */
interface IController extends IObservable, IForm
{
}
