...
namespace Kisma\Aspects\Reactors
{
	 ...
	 */
	class AppEvent extends Components\Aspect implements \Kisma\IDispatcher
	{
		//*************************************************************************
		//* Private Members
		//*************************************************************************
		...
		/**
		 * @var Components\Event[] My events indexed by event name
		 */
		 ...
		 */
		public function create( $eventName, $eventData = null, $eventClass = \KismaSettings::DefaultEventClass )
		{
		 ...
		 * @return Aspects\Reactors\AppEvent
		 */
